<?
	...
	$sql_query				= "SELECT * FROM jobseeker_workhistory WHERE history_id = '$history'";
	...
	$smarty->assign("jobseeker_work_id"						, $history								);
	$smarty->assign("jobseeker_work_start_month"			, $history_start_month					);
	$smarty->assign("jobseeker_work_start_year"				, $history_start_year					);
	$smarty->assign("jobseeker_work_end_month"				, $history_end_month					);
	$smarty->assign("jobseeker_work_end_year"				, $history_end_year						);
	$smarty->assign("jobseeker_work_end_present"			, $history_end_present					);
	$smarty->assign("jobseeker_work_company"				, $history_company						);
	$smarty->assign("jobseeker_work_industry"				, $history_industry						);
	$smarty->assign("jobseeker_work_jobfunction"			, $history_jobfunction					);
	$smarty->assign("jobseeker_work_position"				, $history_position						);
	$smarty->assign("jobseeker_work_salary"					, $history_salary						);
	$smarty->assign("jobseeker_work_achievement"			, $history_achievement					);
	$smarty->assign("status_img_captcha"					, $status_img_captcha					);
	$smarty->display('jobseeker_resume_step7_edit.html');	
