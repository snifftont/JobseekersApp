<?
	...
	$jobseeker_r_file_loc			= "$dir_resume/$jobseeker_id/$jobseeker_r_file";
	
	if (file_exists($jobseeker_r_file_loc)) {
		$jobseeker_r_file			= "$url_resume/$jobseeker_id/$jobseeker_r_file";
	}
	else {
		$jobseeker_r_file			= "";
	}
	...
	$smarty->assign("next_found"						, $found_next						);
	$smarty->assign("next_id"							, $id_next							);
	$smarty->assign("prev_found"						, $found_previous					);
	$smarty->assign("prev_id"							, $id_previous						);
	...
	$smarty->assign("jobseeker_id"						, $jobseeker						);
	...
	$smarty->display('employer_job_jobseekers_detail.html');	
