<?
	...
	$job		= $job - $start_job;
	$sql_query	= "UPDATE job SET job_stat_views = job_stat_views + '1' WHERE job_id = '$job'";
	...
	$job_title_limited		= FE10AC7A9A6B41E1A46CD505297394F52($job_title, 30);
	...
	$job_url_company_list		= "site_company_list.php?company=$employer_number";;
	...
	if($status_url_rewrite == "yes") {	
		...
		$job_url_company_list 	= "company-$employer_number-0-1-$employer_company_mod.php"; 
	}
	...
	$smarty->assign("job_title_limited"				, $job_title_limited			);
	...
	$smarty->assign("job_url_company_list"			, $job_url_company_list			);
